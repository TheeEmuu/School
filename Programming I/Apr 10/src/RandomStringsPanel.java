...
public class RandomStringsPanel extends JPanel {
    ...
    public RandomStringsPanel() {
        this(new String[]{null});  // Call the other constructor, with parameter null.
    }
    ...
    public RandomStringsPanel(String[] messageString) {
        ...
        messages = new String[messageString.length];
        for(int i = 0; i < messageString.length; i++) {
            if (messageString[i] == null)
                messages[i] = "Java!";
            else
                messages[i] = messageString[i];
        }
    ...
    public void paintComponent(Graphics g) {
        ...
        for (int i = 0; i < 25; i++) {
            ...
            // Draw the message.
            int messageIndex = (int)(Math.random()*messages.length)-1;
            if(messageIndex < 0)
                messageIndex = 0;
