...
public class LengthConverter {
    ...
    public static void main(String[] args) {
        ...
        double inches, feet, yards, miles, meters;  // Measurement expressed in
        ...
        while (true) {
            ...
            else if (units.equals("meter") || units.equals("meters") || units.equals("m")){
                inches = measurement * 39.370;
            }
            else {
            ...
            System.out.printf("%12.5g", meters);
