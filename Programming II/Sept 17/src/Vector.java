...
public class Vector
{
    ...
    //pre:  The given item Object should be removed from the Vector; item may or may not be an element of the Vector
    //post:  Return the removed item (null if the item was not found); item is removed from the Vector and the Vector size decreases by 1
    ...
    public Object clone()
    {
        ...
        } catch (CloneNotSupportedException e) { Assert.fail("Vector cannot be cloned."); }
        return copy;
    }
