package structure;// A class that converts a structure.Structure to a Collection
...
/**
 * This utility class converts a structure.Structure to a Collection.
 * Users are advised to make use of the <code>values</code> method
 * that is part of every <code>structure.Structure</code> that returns a <code>Collection</code>.
 * <p>
 ...
 * interface are directly referred to the base structure.Structure, or simple
 * code supports the interface.
 *
 * @author, 2001 duane a. bailey
 * @version $Id: structure.StructCollection.java 8 2006-08-02 19:03:11Z bailey $
 * @since Java Structures, 2nd edition
 */
public class StructCollection implements Collection
{
    /**
     * The subordinate structure.Structure
     */
    ...
    /**
     * Add an object to the subordinate structure.Structure, and return boolean
     * indicating success.
     * @post the object o is added to the structure.Structure, and true is returned
     * @return true.
     */
    ...
    /**
     * Adds all the elements of another collection (c) into this structure.Structure.
     * A boolean value of true is returned.
     * @pre c is a valid collection
     * @post the elements of c have been added to the structure.Structure, and
    ...
    /**
     * Remove all elements from the structure.Structure.
     ...
     * @pre c is a valid Collection
     * @post returns true if all elements of c appear in this structure.Structure
    ...
    /**
     * Compare one structure.StructCollection with another.
     * @pre o is of similar type to base structure.Structure
    ...
    /**
     * Construct an array of values found in the subordinate structure.Structure.
    ...
    {
        return "<structure.StructCollection wrapping "+base+">";
    }
}
