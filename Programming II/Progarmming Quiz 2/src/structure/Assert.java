package structure;// Routines used for testing assertions.
 ...
 * @version $Id: structure.Assert.java 8 2006-08-02 19:03:11Z bailey $
...
public class Assert
{
    ...
    /**
     * @pre An structure.Assert cannot be constructed
     */
    private Assert()
    {
        Assert.fail("Attempt to construct an structure.Assert!?");
    }
    ...
    /**
     * structure.Set up a level 1 debugging message.
     *
    ...
    /**
     * structure.Set up a debugging message at a specific level.
     *
