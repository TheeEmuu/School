package structure;// Implementation of lists, using singly linked elements.
 ...
 *
 * @version $Id: structure.SinglyLinkedList.java 31 2007-08-06 17:19:56Z bailey $
...
public class SinglyLinkedList extends AbstractList
{
    ...
    public Object removeLast()
    {
        Node finger = head;
        Node previous = null;
        Assert.pre(head != null,"structure.List is not empty.");
    ...
    {
        Node finger = head;
        Assert.condition(finger != null,"structure.List is not empty.");
        while (finger != null &&
               finger.next() != null)
        {
            finger = finger.next();
    ...
    /**
     * structure.Set value stored at location i to object o, returning old value.
     *
     * @pre 0 <= i < size()
    ...
    */
    ...
    public String toString()
    {
        ...
        s.append("<structure.SinglyLinkedList:");
