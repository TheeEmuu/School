package structure;// Interface of a basic, mutable data structure.
 ...
 * structure.AbstractStructure.  The structure.AbstractStructure implements the isEmpty,
 * contains and collection methods.  They may be overridden if a particularly
 * efficient technique is to be preferred.
 *
 * @author, 2001 duane a. bailey
 * @version $Id: structure.Structure.java 31 2007-08-06 17:19:56Z bailey $
