package structure;// A set implemented using vectors.  Slow, but works on non-Comparables.
 ...
 *
 * @version $Id: structure.SetVector.java 8 2006-08-02 19:03:11Z bailey $
...
public class SetVector extends AbstractSet
{
    ...
    {
        return "<structure.SetVector: "+data+">";
    }
}
