package structure;// Abstract base class for portable iterator and enumeration implementation.
 ...
 * Typical usage:
 * <pre>
 *     structure.Vector v = new structure.Vector();
 *     String s = "target";
 *     ...
 ...
 * may treat the <code>structure.AbstractIterator</code> as an <code>Enumeration</code> or
 ...
 * @version $Id: structure.AbstractIterator.java 8 2006-08-02 19:03:11Z bailey $
 * @see Iterator
 * @see Enumeration
 */
    ...
    implements Enumeration, Iterator
{
    ...
    /**
     * Returns the value currently being considered by the structure.AbstractIterator.
