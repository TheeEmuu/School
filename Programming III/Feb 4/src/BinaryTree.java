...
public abstract class BinaryTree<E> {
	...
	public boolean equals(BinaryTree<E> other){
		...
		TreeIterator<E> otherIter = other.iterator();
...
//		BinaryTree copy = tree.root;
//		copy.setRoot(tree.getRoot());
//		return copy;
//	}

//	public static boolean isAVL(BinaryTree tree){
//
//	}
	public int slowSize(){
		size = 0;
	...
	private int slowSize(Node<E> n){
		if(n.data == null) return 0;

		size = size + slowSize(n.left);
		size = size + slowSize(n.right);
		return size;
	}
